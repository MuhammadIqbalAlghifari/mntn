...
export default function FooterSection() {
  ...
  return (
    <footer className="max-w-screen-xl mx-auto flex mt-60 mb-10 p-5 xl:p-0 md:justify-between flex-col md:flex-row gap-y-5 md:gap-y-0 items-stretch h-full w-full">
        <div className="flex flex-col max-w-sm justify-between gap-y-2 md:gap-y-0 items-stretch h-auto w-full">
            <div className="flex flex-col justify-center gap-y-2.5 xl:gap-y-5 items-start">
                ...
                <p className="text-white max-w-xs xl:text-lg lg:text-sm text-start" style={{fontFamily: 'Gilroy Bold'}}>Get out there & discover your next slope, mountain & destination!</p>
            </div>
            <p className="text-slate-500 xl:text-lg lg:text-sm text-start" style={{fontFamily: 'Gilroy Medium'}}>Copyright {currentYear} MNTN, Inc. Terms & Privacy</p>
        </div>
        <div className="flex flex-col md:flex-row justify-between gap-y-5 md:gap-y-0 items-start w-full max-w-xl">
            <div className="flex flex-col justify-between items-start h-auto gap-y-2.5 lg:gap-y-5">
